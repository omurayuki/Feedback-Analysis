...
final class GoalPostUIImpl: GoalPostUI {
    ...
    private(set) var draftBtn: UIBarButtonItem = {
...
extension GoalPostUIImpl {
    func setup() {
        registerNavItem.leftBarButtonItem = cancelBtn
        registerNavItem.rightBarButtonItems = [saveBtn, draftBtn]
