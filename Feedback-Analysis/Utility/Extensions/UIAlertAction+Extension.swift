...
extension UIAlertController {
    ...
    class func createScoreEditActionSheet(tappedEditScore: @escaping () -> Void,
        ...
        let useGnpScoreAction = UIAlertAction(title: "R.string.localizable.frame_selected_action_sheet_gnp()", style: .default) { _ -> Void in
            tappedUseGnpScore()
        }
        
        let cancelAction = UIAlertAction(title: "R.string.localizable.cancel_en()", style: .cancel)
